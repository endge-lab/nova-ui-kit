...
export function normalizeCheckboxProps(props: CheckboxProps = {}): CheckboxResolvedProps {
  return {
    ...normalizeCommonProps(props, {
      width: 160,
      height: 28,
      color: 'var(--nova-checkbox-color, #172033)',
      accentColor: 'var(--nova-checkbox-accent-color, #2563eb)',
      background: 'var(--nova-checkbox-background, #ffffff)',
      border: { color: 'var(--nova-checkbox-border-color, #cbd5e1)', width: 1, radius: 4 },
      hoverBackground: 'var(--nova-checkbox-hover-background, #f8fafc)',
      pressedBackground: 'var(--nova-checkbox-pressed-background, #eff6ff)',
