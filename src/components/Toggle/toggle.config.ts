...
export function normalizeToggleProps(props: ToggleProps = {}): ToggleResolvedProps {
  return {
    ...normalizeCommonProps(props, {
      width: 148,
      height: 30,
      color: 'var(--nova-toggle-color, #172033)',
      accentColor: 'var(--nova-toggle-accent-color, #2563eb)',
      trackColor: 'var(--nova-toggle-track-color, #cbd5e1)',
      thumbColor: 'var(--nova-toggle-thumb-color, #ffffff)',
      border: { color: 'var(--nova-toggle-border-color, #cbd5e1)', width: 1, radius: 999 },
